    ...
    <section className={'about-project'}>
      <div className={'about-project__content'}>
        ...
        <section className={'about-project__progress'}>
          <div className={'about-project__progress__back'}>
            <p className={'about-project__progress__text progress__back__text'}>{resources_ru.one_week}</p>
            <p className={'about-project__progress__subtext'}>Back-end</p>
          </div>
          <div className={'about-project__progress__front'}>
            <p className={'about-project__progress__text progress__front__text'}>{resources_ru.four_weeks}</p>
            <p className={'about-project__progress__subtext'}>Front-end</p>
          </div>
        </section>
      </div>
    </section>
